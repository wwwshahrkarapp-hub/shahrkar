    ...
    <main className="max-w-3xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          ...
          <option value="simple-worker">کارگر ساده</option>
          <option value="marketing">بازاریابی و فروش</option>
          <option value="design">طراحی و هنر</option>
          <option value="mixed">آگهی مختلط</option>
          <option value="it">فناوری اطلاعات و برنامه‌نویسی</option>
        </select>
